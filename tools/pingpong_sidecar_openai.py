...
_SENSITIVE_TOPICS: Dict[str, Dict[str, Any]] = {
    "politics": {
        ...
        "response": "정치 관련 대화는 핑퐁이가 도와드리기 어려워요. 역핑 서비스에 대해 궁금한 점이 있으면 물어봐 주세요! 😊",
    },
    "religion": {
        "keywords": ["기독교", "불교", "이슬람", "천주교", "교회", "절에", "사찰", "성경", "코란",
                      "하나님", "부처님", "알라", "예수", "종교", "신앙"],
        "response": "종교 관련 대화는 핑퐁이가 도와드리기 어려워요. 역핑 서비스에 대해 궁금한 점이 있으면 물어봐 주세요! 😊",
    },
    "discrimination": {
        "keywords": ["혐오", "차별", "인종", "성차별", "여혐", "남혐", "장애인 비하", "외국인 혐오",
                      "흑인", "동남아", "조선족"],
        "response": "차별이나 혐오 관련 대화는 핑퐁이가 도와드리기 어려워요. 모든 사람은 소중합니다. 😊",
    },
    "crime": {
        "keywords": ["살인", "폭행", "마약", "대마", "필로폰", "해킹 방법", "불법 도박", "몰카",
                      "성범죄", "사기 치는 법", "협박", "납치"],
        "response": "불법 행위 관련 안내는 핑퐁이가 도와드리기 어려워요. 긴급 상황이라면 112(경찰) 또는 119(소방)에 연락해 주세요.",
    },
    "profanity": {
        "keywords": ["시발", "씨발", "ㅅㅂ", "ㅆㅂ", "개새끼", "병신", "ㅂㅅ", "지랄", "ㅈㄹ",
                      "꺼져", "닥쳐", "미친놈", "미친년", "존나", "ㅈㄴ"],
        "response": "욕설이나 비속어는 핑퐁이가 대응하기 어려워요. 편하게 질문해 주시면 성심껏 도와드릴게요! 😊",
        "log": True,
    },
    "adult": {
        "keywords": ["야동", "포르노", "성인물", "섹스", "자위", "매춘", "성매매", "av배우",
                      "19금", "음란"],
        "response": "성인 콘텐츠 관련 대화는 핑퐁이가 도와드리기 어려워요. 역핑 서비스에 대해 궁금한 점이 있으면 물어봐 주세요! 😊",
    },
    "self_harm": {
        "keywords": ["자살", "자해", "죽고 싶", "삶이 힘들", "극단적 선택", "목숨"],
        "response": "힘든 시간을 보내고 계시다면, 전문 상담을 받아보시길 권합니다.\n"
                     "- 자살예방상담전화: 1393\n"
                     "- 정신건강위기상담전화: 1577-0199\n"
                     "- 생명의전화: 1588-9191\n"
                     "전문가의 도움이 큰 힘이 될 수 있어요. 🙏",
    },
    "medical": {
        "keywords": ["암 치료", "약 처방", "진단해줘", "증상이", "병원 추천", "항암제", "수술 방법",
                      "우울증 약", "당뇨 치료", "혈압 약"],
        "response": "의료 관련 질문은 핑퐁이가 정확한 안내를 드리기 어려워요. 반드시 의사/약사 등 전문가와 상담해 주세요. 🏥",
    },
    "legal": {
        "keywords": ["소송 방법", "고소 하려면", "변호사 추천", "법적 책임", "형사 고발", "민사 소송",
                      "합의금", "벌금 얼마"],
        "response": "법률 관련 질문은 핑퐁이가 정확한 안내를 드리기 어려워요. 법률 전문가(변호사, 법률구조공단 132)와 상담해 주세요. ⚖️",
    },
    "investment": {
        "keywords": ["주식 추천", "코인 추천", "투자 종목", "몇 배 오를", "매수 타이밍", "공매도",
                      "선물 거래", "레버리지", "떡상"],
        "response": "투자 조언은 핑퐁이가 도와드리기 어려워요. 투자는 본인의 판단과 책임하에 진행해 주세요. 📊",
    },
}
