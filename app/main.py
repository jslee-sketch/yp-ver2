...
_alter_cols = [
    ...
    # 분쟁 구조화 제안 (v4)
    ("disputes", "initiator_amount_type", "VARCHAR(10) DEFAULT 'fixed'"),
    ("disputes", "initiator_amount_value", "DOUBLE PRECISION"),
    ("disputes", "initiator_amount_calculated", "INTEGER"),
    ("disputes", "initiator_shipping_burden", "VARCHAR(20) DEFAULT 'seller'"),
    ("disputes", "initiator_return_required", "BOOLEAN"),
    ("disputes", "r1_respondent_amount_type", "VARCHAR(10)"),
    ("disputes", "r1_respondent_amount_value", "DOUBLE PRECISION"),
    ("disputes", "r1_respondent_amount_calculated", "INTEGER"),
    ("disputes", "r1_respondent_shipping_burden", "VARCHAR(20)"),
    ("disputes", "r1_respondent_return_required", "BOOLEAN"),
    ("disputes", "r1_ai_amount_type", "VARCHAR(10)"),
    ("disputes", "r1_ai_amount_value", "DOUBLE PRECISION"),
    ("disputes", "r1_ai_shipping_burden", "VARCHAR(20)"),
    ("disputes", "r1_ai_return_required", "BOOLEAN"),
    ("disputes", "r1_ai_legal_basis", "TEXT"),
    ("disputes", "r1_ai_nudge_buyer", "TEXT"),
    ("disputes", "r1_ai_nudge_seller", "TEXT"),
    ("disputes", "r2_initiator_amount_type", "VARCHAR(10)"),
    ("disputes", "r2_initiator_amount_value", "DOUBLE PRECISION"),
    ("disputes", "r2_initiator_amount_calculated", "INTEGER"),
    ("disputes", "r2_initiator_shipping_burden", "VARCHAR(20)"),
    ("disputes", "r2_initiator_return_required", "BOOLEAN"),
    ("disputes", "r2_respondent_amount_type", "VARCHAR(10)"),
    ("disputes", "r2_respondent_amount_value", "DOUBLE PRECISION"),
    ("disputes", "r2_respondent_amount_calculated", "INTEGER"),
    ("disputes", "r2_respondent_shipping_burden", "VARCHAR(20)"),
    ("disputes", "r2_respondent_return_required", "BOOLEAN"),
    ("disputes", "r2_ai_amount_type", "VARCHAR(10)"),
    ("disputes", "r2_ai_amount_value", "DOUBLE PRECISION"),
    ("disputes", "r2_ai_shipping_burden", "VARCHAR(20)"),
    ("disputes", "r2_ai_return_required", "BOOLEAN"),
    ("disputes", "r2_ai_legal_basis", "TEXT"),
    ("disputes", "r2_ai_nudge_buyer", "TEXT"),
    ("disputes", "r2_ai_nudge_seller", "TEXT"),
    ("disputes", "accepted_proposal_source", "VARCHAR(20)"),
    ("disputes", "accepted_proposal_type", "VARCHAR(30)"),
...
try:
    ...
    # app/static (git 커밋) 우선, frontend/dist (nixpacks 빌드) fallback
    _APP_STATIC = _SpaPath(__file__).parent / "static"
    _FRONTEND_DIST_ORIG = _SpaPath(__file__).parent.parent / "frontend" / "dist"
    # app/static에 index.html이 있으면 우선 사용 (git으로 관리되는 빌드)
    if (_APP_STATIC / "index.html").is_file():
        _FRONTEND_DIST = _APP_STATIC
    elif _FRONTEND_DIST_ORIG.is_dir():
        _FRONTEND_DIST = _FRONTEND_DIST_ORIG
    else:
        _FRONTEND_DIST = _APP_STATIC
